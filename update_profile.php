...
if (isset($_POST['update_profile'])) {
    ...
    if (!empty($_POST['update_num_tel']) && $_POST['update_num_tel'] !== $fetch['numero_tel']) {
        $update_num_tel = mysqli_real_escape_string($conn, $_POST['update_num_tel']);
    ...
    $update_pass = !empty($_POST['update_pass']) ? mysqli_real_escape_string($conn, md5($_POST['update_pass'])) : '';
    $new_pass = !empty($_POST['new_pass']) ? mysqli_real_escape_string($conn, md5($_POST['new_pass'])) : '';
    $confirm_pass = !empty($_POST['confirm_pass']) ? mysqli_real_escape_string($conn, md5($_POST['confirm_pass'])) : '';
